package tech.hiphone.app.aop.logging;

import static tech.hiphone.framework.config.ProfileConstants.SPRING_PROFILE_DEVELOPMENT;
...
public class LoggingAspect {
    ...
    private final String BASE_PACKAGE = "tech.hiphone";
